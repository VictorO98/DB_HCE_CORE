...
DELIMITER //
CREATE PROCEDURE insertExamen_Fisico (IN ESTADOCONCIENCIA VARCHAR(25), IN LENGUAJE VARCHAR(25), IN AUDITIVO VARCHAR(25), IN AGUDEZAVISUAL VARCHAR(25), 
...
DELIMITER //
CREATE PROCEDURE updateExamen_Fisico(IN ID INT, IN ESTADOCONCIENCIA VARCHAR(25), IN LENGUAJE VARCHAR(25), IN AUDITIVO VARCHAR(25), IN AGUDEZAVISUAL VARCHAR(25), 
								IN PESO FLOAT(10), IN ESTATURA FLOAT(10), IN FACIE VARCHAR(25),IN  EDADREALAPATENTE VARCHAR(25), IN TEMPERATURA FLOAT(10),IN  ACTITUD VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idExamen FROM Examen_Fisico WHERE idExamen = ID)) THEN 
		START TRANSACTION;
...
DELIMITER //
CREATE PROCEDURE insertHabito (IN ALIMENTACION VARCHAR(25),IN APETITO VARCHAR(25), IN SED VARCHAR(25), IN DIURESIS VARCHAR(25),
...
DELIMITER //
CREATE PROCEDURE updateHabito(IN ID INT,IN ALIMENTACION VARCHAR(25),IN APETITO VARCHAR(25), IN SED VARCHAR(25), IN  DIURESIS VARCHAR(25),
						 IN CATARSISINTESTINAL VARCHAR(25), IN SUENO VARCHAR(25), IN RELACIONESSEXUALES VARCHAR(25), IN ALCOHOL VARCHAR(25), IN TABACO VARCHAR(25),
						  IN DROGAS VARCHAR(25), IN MEDICACION VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idHabito FROM Habitos WHERE idHabito = ID)) THEN
...
DELIMITER //
CREATE PROCEDURE insertExamenSegmentario (IN CABEZA VARCHAR(25),IN CUELLO VARCHAR(25), IN TORAX VARCHAR(25), IN APARATOCIRCULATORIO VARCHAR(25),
...
DELIMITER //
CREATE PROCEDURE updateExamenSegmentario(IN ID INT,IN CABEZA VARCHAR(25),IN CUELLO VARCHAR(25), IN TORAX VARCHAR(25), IN APARATOCIRCULATORIO VARCHAR(25),
	 					IN APARATORESPIRATORIO VARCHAR(25), IN ABDOMEN VARCHAR(25),	 
	 					IN APARATOUROGENITAL VARCHAR(25), IN SISTEMANERVIOSO VARCHAR(25), IN PSICOLOGICOMENTAL VARCHAR(25), IN PERINE VARCHAR(25),
						  IN EXAMENGENITAL VARCHAR(25), IN MIEMBROSSUPERIOES VARCHAR(25), IN MIEMBROSINFERIORES VARCHAR(25))
BEGIN
...
DELIMITER //
CREATE PROCEDURE insertCitas_Medicas (IN FECHA TIMESTAMP,IN MOTIVO VARCHAR(50), IN EPSAGENDA INT,IN MEDICOS_IDMEDICOS INT,
