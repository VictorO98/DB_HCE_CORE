...
DELIMITER //
CREATE PROCEDURE insertFisiologica (IN ID INT, IN LACTANCIA VARCHAR(25), IN INI_SEXUAL VARCHAR(25), IN GINECO VARCHAR(25),
										IN MENARCA VARCHAR(25), IN EMBARAZOS VARCHAR(25), IN PARTOS VARCHAR(25), IN ABORTOS VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idFisiologica FROM Fisiologica WHERE idFisiologica = ID)) THEN
...
DELIMITER //
CREATE PROCEDURE updateFisiologica (IN ID INT, IN LACTANCIA VARCHAR(25), IN INI_SEXUAL VARCHAR(25), IN GINECO VARCHAR(25),
										IN MENARCA VARCHAR(25), IN EMBARAZOS VARCHAR(25), IN PARTOS VARCHAR(25), IN ABORTOS VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idFisiologica FROM Fisiologica WHERE idFisiologica = ID)) THEN
		START TRANSACTION;
...
DELIMITER //
CREATE PROCEDURE insertAntecedentes (IN ID INT, IN ACCIDENTES VARCHAR(25), IN ANT_HERE VARCHAR(25), IN ENF_INF VARCHAR(25),
										IN INT_QUIRUR VARCHAR(25), IN ALERGIAS VARCHAR(25), IN INMUNIZACION VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idAntecedente FROM Antecedentes WHERE idAntecedente = ID)) THEN
...
DELIMITER //
CREATE PROCEDURE updateAntecedentes (IN ID INT, IN ACCIDENTES VARCHAR(25), IN ANT_HERE VARCHAR(25), IN ENF_INF VARCHAR(25),
										IN INT_QUIRUR VARCHAR(25), IN ALERGIAS VARCHAR(25), IN INMUNIZACION VARCHAR(25))
BEGIN
	IF (SELECT EXISTS (SELECT idAntecedente FROM Antecedentes WHERE idAntecedente = ID)) THEN
		START TRANSACTION;
