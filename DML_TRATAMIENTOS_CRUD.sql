...
DELIMITER //
CREATE PROCEDURE getTratamientoForId (IN ID INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE deleteTratamiento (IN IDBORRAR INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE getMedXTrataForId (IN ID_IN INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE insertMedXTrata (IN IDMED INT ,IN IDTRATA INT ,IN REPE VARCHAR(200))
BEGIN
...
DELIMITER //
CREATE PROCEDURE getMedicamentosForId (IN ID_IN INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE deleteMedicamento (IN IDBORRAR INT)
BEGIN
